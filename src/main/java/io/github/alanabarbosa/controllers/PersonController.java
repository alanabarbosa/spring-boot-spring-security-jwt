...
public class PersonController {
	...
	@GetMapping(value = "/{id}", 
			produces = { MediaType.APPLICATION_JSON, 
					MediaType.APPLICATION_XML,
					MediaType.APPLICATION_YML })
	@Operation(summary = "Finds a People for ID", description = "Finds a People for ID",
		tags = {"People"},
			responses = {
				@ApiResponse(description = "Success", responseCode = "200,", 
	...
	@CrossOrigin(origins = {"http://localhost:8080", "https://iclassstore.com.br"})
	@PostMapping(consumes = { MediaType.APPLICATION_JSON, 
			MediaType.APPLICATION_XML,
			MediaType.APPLICATION_YML })
	@Operation(summary = "Adds a new People", description = "Adds a new People",
		tags = {"People"},
			responses = {
				@ApiResponse(description = "Success", responseCode = "200,", 
						content = @Content (schema = @Schema(implementation = PersonVO.class))
